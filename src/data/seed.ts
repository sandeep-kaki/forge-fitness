...
export function createSeedAppData(): LocalAppData {
  ...
  return { schemaVersion: APP_SCHEMA_VERSION, profile: { id: profileId, displayName: 'Alex', goal: 'muscle_gain', experience: 'beginner', availableDays: [1, 2, 4], preferredDurationMinutes: 45, preferredTrainingTime: '09:00', createdAt: now, updatedAt: now }, inventory: { profileId, availableEquipmentIds: ['dumbbells', 'adjustable-bench', 'cable-station'], updatedAt: now }, safety: { acknowledgedAt: now, version: 1, understandsEmergencyStop: true, understandsNotMedicalAdvice: true }, workoutSettings: { preferredDurationMinutes: 45, voiceEnabled: false, announceRestCountdown: false }, appSettings: { theme: 'dark', reducedMotion: false, schemaVersion: APP_SCHEMA_VERSION }, plans: [], sessions: [], bodyWeightEntries: [] }
}
